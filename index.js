...
function compareArrays(arr1, arr2) {
  ...
  const sortArr1 = arr1.slice().sort((a, b) => a - b);
  const sortArr2 = arr2.slice().sort((a, b) => a - b);

  const comparison = JSON.stringify(sortArr1) === JSON.stringify(sortArr2);

  console.assert(comparison, "Масиви не однакові!");
}
...
function validateUserInput(userInput) {
  ...
  const result = userInput.password.length < 8;
